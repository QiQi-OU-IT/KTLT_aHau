...
// Ham sap xep cac phan tu trong 1 cot theo thu tu giam dan
void sapXepCotGiamDan(int** a, int m, int cot) {
    for (int i = 0; i < m - 1; i++) {
...
int main() {
    ...
    // Sap xep cac phan tu trong cot theo thu tu giam dan
    sapXepCotGiamDan(a, m, cot);

    cout << "Ma tran sau khi sap xep cot " << cot << " theo thu tu giam dan: " << endl;
